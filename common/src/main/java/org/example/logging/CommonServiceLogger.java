...
//
//    // Вручную загружаем свойства из System properties или используем значения по умолчанию
//    private final boolean loggingEnabled;
//    private final String loggingLevel;
//
//    public CommonServiceLogger() {
//        // Загружаем свойства из System properties или используем значения по умолчанию
//        this.loggingEnabled = Boolean.parseBoolean(System.getProperty("logging.aspects.enabled", "true"));
//        this.loggingLevel = System.getProperty("logging.aspects.level", "INFO");
//    }
//
...
//        // Временный отладочный лог для проверки
//        logger.warn("[DEBUG] Aspect triggered for method: {}.{}",
//                joinPoint.getSignature().getDeclaringTypeName(),
//                joinPoint.getSignature().getName());
//        logger.warn("[DEBUG] loggingEnabled: {}, loggingLevel: {}", loggingEnabled, loggingLevel);
...
//
//        String level = loggingLevel != null ? loggingLevel.toUpperCase() : "INFO";
//        switch (level) {
//            case "DEBUG":
